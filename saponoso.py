...
class Saponoso:
    ...
    """
    endpoints = {
        "pro": os.environ.get("SAP_ENDPOINT_PRO", "http://your_pro_sap_server.local:80/sap/bc/soap/rfc"),
        "qas": os.environ.get("SAP_ENDPOINT_QAS", "http://your_qas_sap_server.local:80/sap/bc/soap/rfc"),
    }
